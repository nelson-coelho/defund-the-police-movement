...
# Loading main db
main_initial_db_w_names <- read.csv('C:/Users/sarah/Desktop/lookinto/_DTP article Nov new db/dbs/main_initial_db_w_names.csv')
...
#save copies
#write.csv(main_initial_db_w_ACS, "C:/Users/sarah/Desktop/lookinto/_DTP article Nov new db/dbs/main_initial_db_w_ACS.csv", row.names=FALSE)
#write.csv(ACS, "C:/Users/sarah/Desktop/lookinto/_DTP article Nov new db/dbs/ACS_v2.csv", row.names=FALSE)

#at this point we have 2 cities with missing acs data
#we dont remove them yet, eventually these cities will be removed due to low population
# anthony city, new mexico does not ACS have data for 2011 and 2012
# lake city, tennessee does not have ACS data for 2020, 2021, and 2022
# centreville city, illinois does not have ACS data for 2022
# pecos city, texas does not have ACS data for 2022


#we create a new var and change the month numbers to written
#new month var
...
#create a nw breakln to join with homs and JH dbs below
...
#JH_db_new_cit_ct <- JH_db_new_cit_ct %>% rename_with( ~"BREAKln", "BREAKln_ymo")
...
#simply renaming the column that is used to join tables
#JH_db_new_pol_ct <- JH_db_new_pol_ct %>% rename_with( ~"BREAKln", "BREAKln_ymo")
...
#===============================================================================
# Here we join the JH_db_homs_JH_and_ACS with the Arrest and Personnel data ====
#===============================================================================
# Load and prepare the data ====================================================
# Loading Arrest db and Personnel db
Arrest_db <- read.csv('C:/Users/sarah/Desktop/lookinto/_DTP article Nov new db/dbs/Arrest_db.csv')
#Personnel_db <- read.csv('C:/Users/sarah/Desktop/lookinto/_DTP article Nov new db/dbs/Personnel_db.csv')
...
#save copy
#write.csv(JH_db_homs_JH_and_ACS_arrest, "C:/Users/sarah/Desktop/lookinto/_DTP article Nov new db/dbs/JH_db_homs_JH_and_ACS_arrest.csv", row.names=FALSE)
...
leoka_2010_2022 <- read.csv('C:/Users/sarah/Desktop/lookinto/_DTP article Nov new db/dbs/leoka_2010_2022.csv')
#loead this to join with personnel from leoka
JH_db_homs_JH_and_ACS_arrest <- read.csv('C:/Users/sarah/Desktop/lookinto/_DTP article Nov new db/dbs/JH_db_homs_JH_and_ACS_arrest.csv')
...
#save copy
#write.csv(JH_db_homs_JH_and_ACS_arrest_LEOKApersonnel, "C:/Users/sarah/Desktop/lookinto/_DTP article Nov new db/dbs/JH_db_homs_JH_and_ACS_arrest_LEOKApersonnel.csv", row.names=FALSE)
...
#write.csv(dtp_db_v1, "C:/Users/sarah/Desktop/lookinto/_DTP article Nov new db/dbs/dtp_db_v1_not_clean.csv", row.names=FALSE)
...
#save copy
#write.csv(dtp_db_v1, "C:/Users/sarah/Desktop/lookinto/_DTP article Nov new db/dbs/dtp_db_v1.csv", row.names=FALSE)
