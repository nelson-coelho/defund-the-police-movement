...
#
# Description: This file contains R code to run the linear interpolation.
#
# Modifications:
#
# Changes:
...
# Loading v1
dtp_db_v1 <- read.csv('C:/dbs/dtp_db_v1.csv')
...
#save copy
#write.csv(dtp_db_v2, "C:/dtp_db_v2.csv", row.names=FALSE)
