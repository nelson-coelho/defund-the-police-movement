...
# Loading v2
dtp_db_v2 <- read.csv('C:/Users/sarah/Desktop/lookinto/_DTP article Nov new db/dbs/dtp_db_v2.csv')
...
#save copy
#write.csv(dtp_db_v3, "C:/Users/sarah/Desktop/lookinto/_DTP article Nov new db/dbs/dtp_db_v3.csv", row.names=FALSE)
...
#load db
dtp_db_v3 <- read.csv('C:/Users/sarah/Desktop/lookinto/_DTP article Nov new db/dbs/dtp_db_v3.csv')
...
#save copy
#write.csv(dtp_db_v3_1, "C:/Users/sarah/Desktop/lookinto/_DTP article Nov new db/dbs/dtp_db_v3_1.csv", row.names=FALSE)
