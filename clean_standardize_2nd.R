...
#cleaning
#some city names needed to be changed
...
shr_db <- read_dta('C:/shr_1976_2022.dta')
...
main_initial_db <- read.csv('C:/main_initial_db.csv')
...
#save it
#write.csv(main_initial_db, "C:/main_initial_db_w_names.csv", row.names=FALSE)
